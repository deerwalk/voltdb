    ...
    var GetDatabaseStatus = function(){
        ...
        VdmService.GetDatabaseStatus(function(connection){
            if (!VdmUI.haltRequest){
              ...
              else if (connection.Metadata['DATABASE_STATUS'].statusString == "error"){
                    $(".connectionFail").show()
                    $(".containerFail").html('');
                        ...
                        if(VdmUI.isServerCreate){
                            ...
                            VdmService.UpdateServer(function(connection){
                                ...
                                if(connection.Metadata['SERVER_UPDATE'].status == 200){
                                    ...
                                    if(connection.Metadata['SERVER_UPDATE'].hasOwnProperty('error'))
                                        errorMsg = connection.Metadata['SERVER_UPDATE']['error']
                                    else if(connection.Metadata['SERVER_UPDATE'].hasOwnProperty('statusString'))
                                        errorMsg = connection.Metadata['SERVER_UPDATE']['statusString']
